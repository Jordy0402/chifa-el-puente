        ...
        html += `
            <div class="single-option-group">
                ...
                <select class="opt-arroz" onchange="calculateTotal()">
                    <option value="blanco">Mantener arroz blanco (S/ 0.00)</option>
...
function calculateTotal() {
    ...
    document.getElementById('taper-extra').textContent = `+ S/ ${taperCost.toFixed(2)} por táper (${totalContainers} envase${totalContainers !== 1 ? 's' : ''})`;
